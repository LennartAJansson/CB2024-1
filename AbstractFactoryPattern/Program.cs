/*
Lite kort om bankkort:

Första siffran står för branschtillhörighet och brukar kallas för MII (Major Industry Identifier). 
Har du exempelvis en 4:a som första siffra är det ett VISA kort och 5:a står för Mastercard kort.

Första 6 siffrorna bildar BIN (Bank Identifier Number) och det berättar vilken bank eller 
finansiellt institut som utfärdat kortet.
Ex: 
...
Sista siffran är endast för att kontrollera att allt blivit rätt. 
Det räknas ut med hjälp av de övriga siffrorna i kortnumret genom en viss teknik.
*/

using AbstractFactoryPattern.Interfaces;
using AbstractFactoryPattern.Providers;
...
foreach (string accntNumber in accntNumbers)
{
  ...
  {
    Console.WriteLine("Sorry. The bank with account number ' {0} ' is invalid.", accntNumber);
  }
  else
  {
